...
namespace TimeTrackerFriend
{
    public partial class formBackground : Form
    {
        ...
        public void WindowReminderOpen()       //Moves the reminder form into the screen
        {
            positionWidth += 5;
            this.Location = new Point(firstForm.reminderVerticalPos, positionWidth);
        }

        public void WindowReminderClose()      //Moves the reminder form out of the screen
        {
            positionWidth -= 5;
            this.Location = new Point(firstForm.reminderVerticalPos, positionWidth);
        }
        ...
        private void btnMoveReminder_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            this.Location = new Point(Cursor.Position.X, -105);     //Makes the reminder go to its X position and new Y position
            firstForm.reminderVerticalPos = this.Location.X;
        }
    }
}
